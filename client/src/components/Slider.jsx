    ...
    return (
      <section style={{'background-size': 'cover'}} class="bg-center bg-size-cover bg-no-repeat bg-[url('https://www.shutterstock.com/image-photo/various-dairy-products-600nw-627224804.jpg')] bg-blend-multiply">
          <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
              ...
              <Link to="/search" class="inline-flex justify-center items-center py-3 px-3 text-base font-medium text-center text-zinc-950 rounded-lg bg-zinc-950 bg-opacity-20 hover:bg-opacity-75 border border-gray-900 hover:border-zinc-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    View all products
