...
export default function Slider() {
    return (
      <section style={{'background-size': 'cover'}} class="bg-center bg-size-cover bg-no-repeat bg-[url('https://domf5oio6qrcr.cloudfront.net/medialibrary/9935/dairy-products.jpg')] bg-blend-multiply">
          <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
              <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0" style={{'padding':'90px'}}>
              <Link to="/search" class="inline-flex justify-center items-center py-3 px-3 text-base font-medium text-center rounded-lg bg-zinc-950 bg-opacity-75 text-white hover:text-yellow-400 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                    View all products
